...
import com.gulimall.guliware.dao.WareSkuDao;
...
import com.gulimall.guliware.entity.vo.OrderVo;
import com.gulimall.guliware.entity.vo.SkuHasStockVo;
import com.gulimall.guliware.feign.OrderClient;
import com.gulimall.guliware.feign.ProductSkuClient;
import com.gulimall.guliware.service.WareOrderTaskDetailService;
import com.gulimall.guliware.service.WareOrderTaskService;
import com.gulimall.guliware.service.WareSkuService;
import com.gulimall.guliware.vo.OrderItemVo;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    @Autowired
    private ProductSkuClient productFeignService;
    ...
    @Autowired
    private OrderClient orderFeignService;
    ...
    @Override
    public List<HasStockTo> getSkuHasStock(List<Long> skuIds) {

        List<HasStockTo> skuHasStockVos = skuIds.stream().map(item -> {
            Long count = baseMapper.selectSkuHasStock(item);
            HasStockTo skuHasStockVo = new HasStockTo();
